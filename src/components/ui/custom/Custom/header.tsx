...
<div className='flex items-center gap-x-4'>
    <ul className='flex items-center font-semibold  space-x-4'>
      <li>
        <a  className="hover:text-primary"href='/1'>Menu</a>
      </li>
      <li>
        <a className="hover:text-primary" href='/2'>Orders</a>
      </li>
    </ul>
    <div className="relative">
      <a href="/cart">
      <ShoppingBasket className='hover:text-primary'/></a>
